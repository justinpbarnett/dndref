...
export const DARK: Colors = { bg: '#080706', bgCard: '#111009', bgCardPinned: '#1a1208', bgSurface: '#0c0a07', bgInput: '#0f0c09', border: '#241c12', borderMed: '#302018', borderStrong: '#3e2e1a', textPrimary: '#e4d5b0', textSecondary: '#b09070', textDim: '#7a6448', textMuted: '#4a3c2c', location: '#5a9fd4', npc: '#45b882', faction: '#c44d6a', item: '#c47a2c', unknown: '#6a5840', active: '#3fc878', paused: '#c47a2c', error: '#c44d6a' };
