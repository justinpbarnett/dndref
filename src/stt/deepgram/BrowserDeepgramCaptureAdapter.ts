...
import { openMicrophoneStream } from "./browser-media";
import { BrowserCaptureResources } from "./browser-capture-resources";
import { connectDeepgramBrowserSocket } from "./browser-socket";
