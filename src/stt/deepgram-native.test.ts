...
vi.mock('expo-file-system/legacy', () => ({ default: {}, FileSystemUploadType: { BINARY_CONTENT: 'BINARY_CONTENT' }, deleteAsync: fileSystemMocks.deleteAsync, uploadAsync: fileSystemMocks.uploadAsync }));
