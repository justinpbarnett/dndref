...
export function DebugContent() {
  ...
  const sttStatusColor = { idle: C.textMuted, connecting: C.paused, active: C.active, error: C.error }[sttStatus];
...
const createStyles = (C: Colors) =>
  StyleSheet.create({
    ...
    errorText: { color: C.error, fontSize: 11, fontFamily: F.mono, marginTop: 4, letterSpacing: 0.2 },
