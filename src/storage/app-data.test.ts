...
const storageControls = vi.hoisted(() => ({ getItemGate: null as Promise<void> | null, setItemGate: null as Promise<void> | null }));
...
vi.mock('@react-native-async-storage/async-storage', () => ({
  default: {
    ...
    setItem: vi.fn(async (key: string, value: string) => { await storageControls.setItemGate; storage.set(key, value); }),
