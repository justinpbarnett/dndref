...
export function EntityDetailsModal({ card, visible, onClose }: Props) {
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <Pressable style={styles.backdrop} onPress={onClose} testID="entity-details-backdrop">
        <Pressable
...
const createStyles = (C: Colors) =>
  StyleSheet.create({
    backdrop: { flex: 1, backgroundColor: C.backdrop, alignItems: "center", justifyContent: "center", padding: 18 },
    dialog: {
      width: "100%",
      maxWidth: 720,
      maxHeight: "86%",
