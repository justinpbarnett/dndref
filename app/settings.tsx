...
export default function SettingsScreen() {
  ...
  const { sttSettings, setSttSettings, saveVoice, voiceSaved, isWebSpeech, resetVoiceSettings } =
  ...
  const renderCategory = (cat: (typeof CATEGORIES)[number], mobile = false) => {
    ...
    return (
      <TouchableOpacity
        key={cat.id}
        style={[
          mobile ? styles.tab : styles.sidebarItem,
          active && (mobile ? styles.tabActive : styles.sidebarItemActive),
        ]}
