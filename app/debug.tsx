...
function createStyles(C: Colors) {
  return StyleSheet.create({
    ...
    sectionLabel: { color: C.textDim, fontSize: 9, fontWeight: '700', letterSpacing: 2.5, fontFamily: F.mono, marginBottom: 7 },
    micRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    micDot: { width: 7, height: 7, borderRadius: 4 },
    micLabel: { fontSize: 12, fontFamily: F.mono, letterSpacing: 0.3 },
    errorText: { color: '#c04040', fontSize: 11, fontFamily: F.mono, marginTop: 4, letterSpacing: 0.2 },
    divider: { height: 1, backgroundColor: C.border, marginVertical: 14 },
    hint: { color: C.textSecondary, fontSize: 11, marginBottom: 8, fontFamily: F.mono, letterSpacing: 0.2 },
    examplesRow: { marginBottom: 10, flexGrow: 0 },
    examplesContent: { gap: 6, paddingRight: 4 },
    chip: { backgroundColor: C.bgInput, borderWidth: 1, borderColor: C.borderMed, borderRadius: 3, paddingHorizontal: 10, paddingVertical: 6, maxWidth: 260 },
    chipDisabled: { opacity: 0.3 },
    chipText: { color: C.textSecondary, fontSize: 11, fontFamily: F.display },
    input: { flex: 1, backgroundColor: C.bgInput, color: C.textPrimary, borderRadius: 3, padding: 12, fontSize: 13, lineHeight: 20, borderWidth: 1, borderColor: C.border, fontFamily: F.display },
    inputDisabled: { opacity: 0.4 },
    empty: { color: C.textMuted, fontSize: 13, fontFamily: F.mono },
    row: { flexDirection: 'row', alignItems: 'center', paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: C.border, gap: 8 },
    typeDot: { width: 5, height: 5, borderRadius: 3, opacity: 0.8 },
